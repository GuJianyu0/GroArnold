...
def main_step4_mpfit_fit_DF_x_mass_brief(r_data, DF_data, mass):
    #: data
    # r_bound = None
    r_bound = 20. #consist with triaxiality alignment reference range
    q_axisratio = ads.axis_ratio_by_configuration_data(r_data[:,0:3], r_bound=r_bound) #tgts
    ads.DEBUG_PRINT_V(1, q_axisratio, "axisratio_direct of qy and qz")
...
def main_step5_mpfit_fit_DF_AA_one(
    ...
    ads.DEBUG_PRINT_V(1, M0_selected_fit, "M0_selected_fit")
...
if __name__ == '__main__':
    ...
    if tag_task==1: #xv triaxialization
        ...
        for gadget_type in type_list:
            ...
            # using functions fh_MPLF_log10 or fh_MTPLF_log10
