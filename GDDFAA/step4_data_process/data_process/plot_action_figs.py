...
def plot_actions_3d(
    ...
    if len(params_useful) == 0:
        params_useful = np.zeros((len(DYL),5))
        print("No slices has enough particles.")
    
    # slope_YX = params_useful[:,1]/params_useful[:,0] #slopes of Y-X and Z-X
    # slope_ZX = params_useful[:,2]/params_useful[:,0]
    ads.DEBUG_PRINT_V(1, params_useful, "params_useful")
    ...
    if n_clel<N_plot_slices:
        print("Too less of slices with enough points. Wrong actions. Do not plot this DF of actions.")
        return 0
...
if __name__ == '__main__':
    ...
    # for gadget_type in [1]:
    # for gadget_type in [3]:
